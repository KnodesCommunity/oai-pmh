import { nockFixtures } from "../test/nock.js";

import { OaiPmhError } from "./errors.js";
import { OaiPmh } from "./oai-pmh.js";
...
describe("OaiPmh", () => {
  ...
  describe("errors", () => {
    it("should reject malformed xml arxiv", () => {
      ...
      return oaiPmh.getRecord("oai:arXiv.org:1412.8545", "arXiv").should.be
        .rejectedWith("Returned data does not conform to OAI-PMH");
    });

    it("should reject 404 error", () => {
      const oaiPmh = new OaiPmh("http://example.com/oai", { retry: false });

      return oaiPmh.identify().should.be.rejectedWith(
